...
const PHASE_4 = [
	...
	"10. BEFORE CALLING THE JUDGE, REVIEWERS MUST APPROVE: Launch `reviewer` subagents to review the implementation. Reviewers must call `until_done_reviewer_approve` with approved=true before you can call `until_done_complete`. If reviewers reject, address feedback and relaunch reviewers.",
